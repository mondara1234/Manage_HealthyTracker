    ...
    <div id="main-wrapper">
                ...
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            ...
                            <li class="sidebar-item">
                                <a href="ManageTips.php?UserName=<?php echo($_GET["UserName"]); ?>" class="sidebar-link">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                {window.location='api/delete.php?TrickID=<?php echo ($result["TrickID"]);?>&UserName=<?php echo($_GET["UserName"]); ?>';}"> Delete </a>
                            </td>
                        </tr>
