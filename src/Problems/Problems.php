                ...
                <nav class="sidebar-nav ">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect " href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-alert"></i><span class="hide-menu p-r-10"> ปัญหาที่พบ </span> <span class="label label-danger  ">3</span> </a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="Problems.php" class="sidebar-link"><i class="mdi mdi-alert-octagon"></i><span class="hide-menu"> ปัญหาจากผู้ใช้ </span></a></li>
                                </li>
                            </ul>
                </nav>
            </aside>
                    ...
                    <table width="100%" border="1" >
                        ...
                        while($result = mysqli_fetch_array($query, MYSQLI_ASSOC))
                        {
                            ...
                            <tr>
                                ...
                                <td align="center"><img src="<?php echo ($result["ProblemIMG"]) ?>" width="50" height="50"  ></td>
                                <td align="center"><textarea rows="4" cols="50" style="width: 100%"><?php echo ($result["ProblemDatail"]) ?></textarea></td>
