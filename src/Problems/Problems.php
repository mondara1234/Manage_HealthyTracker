            ...
            <aside class="left-sidebar " data-sidebarbg="skin5">
                <nav class="sidebar-nav ">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="Problems.php?UserName=<?php echo($_GET["UserName"]); ?>" aria-expanded="false">
                    ...
                    <table width="100%" border="1" style="margin-top: 20px; border: black;" class="font-14">
                        ...
                        while($result = mysqli_fetch_array($query, MYSQLI_ASSOC))
                        {
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="api/edit.php?ProblemID=<?php echo ($result["ProblemID"]);?>&UserName=<?php echo($_GET["UserName"]); ?>"> Edit </a>
                                </td>
                                <td align="center">
                                    <a href="JavaScript:if(confirm('Confirm Delete?')==true)
                {window.location='api/delete.php?ProblemID=<?php echo ($result["ProblemID"]);?>&UserName=<?php echo($_GET["UserName"]); ?>';}"> Delete </a>
                                </td>
                            </tr>
