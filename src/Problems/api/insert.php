...
<head>
    ...
    <title>การเพิ่มข้อมูล การแจ้งปัญหา</title>
</head>
...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">การเพิ่มข้อมูล การแจ้งปัญหา</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            <center>
                <form name="edit" action="InsertProblem.php" method="post" enctype="multipart/form-data" target="iframe_target">
                    ...
                    <table width="70%" border="1" style="border: #068e81 double 5px;">
                        <tr>
                            ...
                            <td width="80%">
                                <select name="pProblemType" id="pProblemType">
                                    <option value="select" selected>กรุณาเลือกประเภทของปัญหา</option>
                                    <option value="เซิร์ฟเวอร์มีปัญหา" >เซิร์ฟเวอร์มีปัญหา</option>
                                    <option value="พบข้อบกพร่อง" >พบข้อบกพร่อง</option>
                                    <option value="ระบบไม่เสถียร" >ระบบไม่เสถียร</option>
                        ...
                        <tr>
                            ...
                            <td width="80%"><input type="text" name="pProblemName" style="width: 100%" /></td>
                        </tr>
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> รายละเอียด :</b></td>
                            <td width="80%">
                                <textarea rows="4" style="width: 100%" name="pProblemDatail"  style="width: 100%"></textarea>
                            </td>
                        </tr>
                        <tr>
