...
<head>
    ...
    <title> การเพิ่มข้อมูล คำแนะนำ </title>
</head>
...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">การเพิ่มข้อมูล คำแนะนำ</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            <center>
                <form name="edit" action="InsertRecommend.php" method="post" enctype="multipart/form-data" target="iframe_target">
                    ...
                    <table width="70%" border="1" style="border: #068e81 double 5px;">
                        <tr>
                            ...
                            <td width="80%"><input type="text" name="AU_UserName" style="width: 100%" /></td>
                        </tr>
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> หัวข้อ :</b></td>
                            <td width="80%"><input type="text" name="AU_Title" style="width: 100%" /></td>
                        </tr>
                        <tr>
                            <td width="20%" align="right" valign="top"><b style="margin-right: 2%;"> รายละเอียด :</b></td>
                            <td width="80%">
                                <textarea rows="6" style="width: 100%" name="AU_Datile" ></textarea>
                            </td>
                        </tr>
                        <tr>
