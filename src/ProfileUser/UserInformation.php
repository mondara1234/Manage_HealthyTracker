            ...
            <aside class="left-sidebar " data-sidebarbg="skin5">
                <nav class="sidebar-nav ">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect" href="UserInformation.php?UserName=<?php echo($_GET["UserName"]); ?>" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="hide-menu"> ข้อมูล User </span> </a></li>
                                                ...
                                                <div class="containerID">
                                                    ...
                                                    <div class="row justify-content-between align-items-center m-b-5" >
                                                        ...
                                                        <button  class="font-12" style=" color: white; background: #068e81;"
                                                                 ...
                                                                 {window.location='api/delete.php?UserID=<?php echo ($result["UserID"]) ?>';}"
                                                        >
                                                            ลบข้อมูล
                                                        </button>
                                                    </div>
