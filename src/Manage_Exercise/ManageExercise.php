...
<body class="bg-container">
    <?php
        ...
        $sql = "SELECT * FROM exercisemanage WHERE UserName LIKE '%".$Search."%' ";
            ...
            <div class="container-fluid">
                ...
                <table width="100%" border="1" style="margin-top: 20px;" class="font-14" >
                    ...
                    while($result = mysqli_fetch_array($query, MYSQLI_ASSOC))
                    {
                        ?>
                        <tr>
                            <td align="center"><?php echo ($result["ExerciseID"]) ?>
                            <td align="center"><?php echo ($result["UserName"]) ?></td>
                            <td align="center"><?php echo ($result["ExerciseName"]) ?></td>
                            <td align="center"><img src="<?php echo ($result["ExerciseIMG"]) ?>" width="50" height="50"  ></td>
                            <td align="center"><textarea rows="4" cols="45" ><?php echo ($result["ExerciseDetail"]) ?></textarea></td>
                            ...
                            <td align="center">
                                <a href="api/edit.php?ExerciseID=<?php echo ($result["ExerciseID"]) ?>"> Edit </a>
                            </td>
                            <td align="center">
                                <a href="JavaScript:if(confirm('Confirm Delete?')==true)
                {window.location='api/delete.php?ExerciseID=<?php echo ($result["ExerciseID"]) ?>';}"> Delete </a>
                            </td>
                        </tr>
