...
<head>
    ...
    <title>การเพิ่มข้อมูล สมุดอาหาร</title>
</head>
...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">การเพิ่มข้อมูล สมุดอาหาร</h4>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            <center>
                <form name="edit" action="InsertDiaryUser.php" method="post" enctype="multipart/form-data" target="iframe_target">
                    ...
                    <table width="70%" border="1" style="border: #068e81 double 5px;">
                        ...
                        <tr>
                            ...
                            <td width="80%"><input type="number" name="pFoodNumber" style="width: 100%" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="80%">
                                <input type="date" name="pDiaryDate" />
                            </td>
                        </tr>
                        <tr>
