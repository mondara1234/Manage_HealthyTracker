...
<head>
    ...
    <title>ฐานข้อมูล รายการอาาหาร</title>
                ...
                <center>
                    <form name="search" method="post">
                        <table width="80%" border="0">
                            <tr>
                                <th> <div align="center" class="font-16"> ชื่ออาหาร :
                ...
                <table width="100%" border="1" style="margin-top: 20px; border: black;" class="font-14">
                    ...
                    while($result = mysqli_fetch_array($query, MYSQLI_ASSOC))
                    {
                        ...
                        <tr>
                            ...
                            <td align="center" style="width: 15%; height: 100px; padding: 0.2%"><img src="<?php echo ($result["FoodIMG"]) ?>" width="99%" height="98%" style="margin: 3% 0px 3% 0px"></td>
